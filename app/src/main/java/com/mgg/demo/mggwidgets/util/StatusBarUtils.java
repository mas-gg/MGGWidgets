...
public class StatusBarUtils {
    ...
    public static void translucentDialogBg(Window window) {
    ...
    public static boolean supportTransparentStatusBar() {
        return OSUtils.isMiui()
                || OSUtils.isFlyme()
                || ((OSUtils.isOppo() || OSUtils.isVivo()) && Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP)
    ...
    public static void transparentStatusBar(Window window) {
        ...
        } else if ((OSUtils.isOppo() || OSUtils.isVivo()) && Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            transparentStatusBarAbove21(window);
